...
weights = matrix20152020(1,:) /sum(matrix20152020(1,:))

res = weights * ((matrix20152020(1201,:) - matrix20152020(1,:))./matrix20152020(1,:))'
...
%     end 
    ...
    bank = 1/96;                                % current period bank proportion
    risky_assets = ones(95,1)*1/95;             % current period risky proportion
    ...
    monthly = mu0_3month * bank + curr_mu * ones(95,1)*1/96;
